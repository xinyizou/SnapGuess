...
public class GameScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Stacey
        final String convoA[] = {"", "Yes", "Is the character male?", "Yes", "Is her hair black?", "Yes", "Is the character looking at the camera?", "No", "Congratulations, you win!"};
        // Alex
        final String convoB[] = {"", "Is the character male?", "No", "Is he wearing something on his head?", "Yes", "Does the character have something covering his face?", "Yes", "Does he have a football helmet on?","You lose better luck next time" };
